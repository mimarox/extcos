...
public class AnnotatedWithFilterObjectsBuilder extends
	...
	private void buildFilterObjects(Class<? extends Annotation> annotation,
			Connector connector) {
	...
	private void buildFilterObjects(Class<? extends Annotation> annotation,
			ArgumentsDescriptor arguments, Connector connector) {
	...
	private void buildFilterObjects(Class<? extends Annotation> annotation,
			ArgumentMapping mapping, Connector connector) {
		TypeFilter filter =
	...
	private void buildFilterObjects(Class<? extends Annotation> annotation,
			ArgumentMappingConjunction mappingConjunction, Connector connector) {
	...
	private void buildFilterObjects(Class<? extends Annotation> annotation,
			ArgumentMappingDisjunction mappingDisjunction, Connector connector) {
		TypeFilter filter =	new AnnotatedWithTypeFilterImpl(annotation,
